...
types of data, such as XML or JSON schema or instance files or Java class files.
You design your data mapping in the AtlasMap Data Mapper UI canvas, and then run that mapping
by means of the AtlasMap runtime engine. We provide standard canned transformations or we
